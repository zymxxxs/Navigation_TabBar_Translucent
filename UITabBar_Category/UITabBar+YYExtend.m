...
#import "UITabBar+YYExtend.h"
#import <objc/runtime.h>

@implementation UITabBar (YYExtend)
...
-(void)setBarTintColorForTranslucent:(UIColor *)color
{
    ...
    if (self.overColorLayer == nil) {
        ...
        self.overColorLayer.frame = CGRectMake(0, 0, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds));
